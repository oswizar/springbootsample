...
public class Md5Utils {
    ...
    public Md5Utils(InputStream in) {
        this.stringp = false;
        this.in = in;
        this.state = new int[4];
        this.buffer = new byte[64];
    ...
    public static void main(String args[])
            throws IOException {
        String a = Md5Utils.getMd5String("jinzhu800311") + "9342";
        System.out.println("密码：" + Md5Utils.getMd5String(a));
    ...
    public static String getMd5String(String value) {
        Md5Utils md5 = new Md5Utils(value);
        md5.processString();
