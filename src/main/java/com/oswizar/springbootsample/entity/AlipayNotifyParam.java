...
public class AlipayNotifyParam implements Serializable {
    ...
    private String appId; //支付宝提供的应用编号
    ...
    private String gmtCreate; // 该笔交易创建的时间。格式为yyyy-MM-dd HH:mm:ss
    private String gmtPayment; // 该笔交易的买家付款时间。格式为yyyy-MM-dd HH:mm:ss
    private String gmtRefund; // 该笔交易的退款时间。格式为yyyy-MM-dd HH:mm:ss.S
    private String gmtClose; // 该笔交易结束时间。格式为yyyy-MM-dd HH:mm:ss
